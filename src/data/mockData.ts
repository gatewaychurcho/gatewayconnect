...
export const MOCK_TESTIMONIES: Testimony[] = [
  ...
  },
  {
    ...
    user_name: 'Lead System Developer (mrjuice017)',
    ...
    category: 'Ministry Milestone',
    content: 'Grace and peace saints! Gateway Connect is active with instant offline sermon downloads, low-data streaming for Econet & NetOne, and integrated EcoCash, Card, and PayPal store orders. Blessed to build for the Kingdom!',
    image_url: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=800&auto=format&fit=crop&q=80',
    scripture_tag: 'Habakkuk 2:2',
    date: '1 hr ago',
