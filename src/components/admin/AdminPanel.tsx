          ...
          {activeSection === 'finances' && (
            <div className="space-y-4">
              <div className="bg-[#001F3F] border border-white/10 rounded-2xl p-4 shadow-sm space-y-4">
                ...
                <div className="bg-[#001122] p-4 rounded-xl border border-white/10 space-y-2">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-bold text-[#D4AF37]">Active Ledger ($0 Base / Target $500,000)</span>
                  </div>
                  <div className="w-full bg-white/10 rounded-full h-2.5 overflow-hidden">
                    <div className="bg-[#D4AF37] h-full rounded-full w-[2%]"></div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#001F3F] border border-white/10 rounded-2xl p-4 shadow-sm space-y-3">
                ...
                {donations.length === 0 ? (
                  <div className="p-8 text-center space-y-2 bg-[#001122]/50 rounded-xl border border-white/5">
